...
public interface IBusinessCurNetData {
    public abstract List<Map<String, String>> getCurNetDataInfo( Ne paramINeElement, String paramString2);

    public abstract List<Map<String, String>> getStdDataInfo(BusiDict busiDict, String[] neNames);

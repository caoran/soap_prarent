...
public interface IData {
    ...
    public abstract long getRangeCheckedBeg();

    public abstract void setRangeCheckedBeg(long paramLong);

    public abstract long getRangeCheckedEnd();

    public abstract void setRangeCheckedEnd(long paramLong);

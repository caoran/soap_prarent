...
public class CheckTypeExtExecutorImpl implements ICheckTypeExecutor {
    @Override
    public List<IDataCheckReturn> checkLogic(List<ICheckData> paramList1, List<ICheckData> paramList2, ICheckEngine paramICheckEngine) {
        return null;
    }
}

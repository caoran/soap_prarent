...
public interface IBusinessLoginCurNetData {
     Map<String, List<ICheckData>> createCurNetCheckDatas(BusinessSubTaskContext paramBusinessSubTaskContext, String paramString, Map<String, MatchResult> paramMap, Ne paramINeElement);
}

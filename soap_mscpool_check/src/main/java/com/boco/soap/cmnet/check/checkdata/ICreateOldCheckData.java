...
public interface ICreateOldCheckData {
    Map<String, List<ICheckData>> createOldCheckData(BusinessSubTaskContext paramBusinessSubTaskContext, Map<String, MatchResult> paramMap, Ne paramINeElement, String paramString);
}

package com.boco.soap.cmnet.mongo.bean;
...
public class OrderMongo implements Serializable{
    ...
    //核查结果
    private Map<String, Map> checkResult;
    ...
    public Map<String, Map> getCheckResult() {
        return checkResult;
    }

    public void setCheckResult(Map<String, Map> checkResult) {
